  ...
  return (
    <footer className="px-4 py-10 sm:py-16 border-t border-border">
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* Link columns — always 2 cols */}
        <div className="grid grid-cols-2 gap-8">
          {/* Useful Links */}
          <div>
            <h4 className="text-sm font-semibold text-foreground mb-4">Useful Links</h4>
          ...
          {/* GitHub */}
          <div>
            <h4 className="text-sm font-semibold text-foreground mb-4">GitHub</h4>
            <ul className="space-y-3">
              <li>

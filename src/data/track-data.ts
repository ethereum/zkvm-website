      ...
      dependencyGraph: {
        nodes: [
          // Execution clients
          {
            ...
            x: 20,
            y: 20,
            description: 'Spec compliant execution client'
          },
          {
            id: 'ethrex',
            label: 'Ethrex',
          ...
          },
          {
            ...
            x: 20,
            y: 60,
            description: 'Most widely used execution client'
          },
          {
            id: 'nethermind',
            label: 'Nethermind',
            ...
            x: 20,
            y: 80,
            description: '.NET execution client'
          },

          // Milestones
          {
            id: 'execution-witness',
            label: 'ExecutionWitness',
            type: 'milestone' as const,
            status: 'in-progress' as const,
            x: 50,
            y: 50,
            description: 'Generate execution witness data structure'
          },
          {
            id: 'zkvm-compilation',
            label: 'zkVM Compilation',
            type: 'milestone' as const,
            status: 'in-progress' as const,
            x: 70,
            y: 30,
            description: 'Compile to zkVM target'
          },
          ...
          // Integration points
          {
            id: 'mainnet-ready',
            label: 'Mainnet Ready',
            type: 'integration-point' as const,
            status: 'not-started' as const,
            x: 90,
            y: 50,
            description: 'Ready for mainnet deployment'
          }
        ],
        edges: [
          // Reth dependencies
          { from: 'reth', to: 'zkvm-compilation', type: 'enables' as const },
          { from: 'zkvm-compilation', to: 'mainnet-ready', type: 'enables' as const },

          // Ethrex dependencies
          { from: 'ethrex', to: 'zkvm-compilation', type: 'enables' as const },

          // Geth dependencies
          { from: 'geth', to: 'execution-witness', type: 'depends-on' as const },
          { from: 'execution-witness', to: 'zkvm-compilation', type: 'enables' as const },

          // Nethermind dependencies
          { from: 'nethermind', to: 'execution-witness', type: 'depends-on' as const }
        ]
      }
    },
    {
